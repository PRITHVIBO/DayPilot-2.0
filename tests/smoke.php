...
foreach(['users','tasks','events','notes','reminders','push_subscriptions','projects','work_logs','daily_reviews','memory_chunks'] as $t){if(strpos($sql,'CREATE TABLE IF NOT EXISTS '.$t)===false){fwrite(STDERR,"Missing table $t\n");exit(1);}}
