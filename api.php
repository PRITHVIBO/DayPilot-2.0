...
// Normalize the action so harmless query encoding/whitespace cannot turn a valid route into 'Unknown action'.
$rawAction = (string)($_GET['action'] ?? 'boot');
$action = trim(rawurldecode($rawAction));
